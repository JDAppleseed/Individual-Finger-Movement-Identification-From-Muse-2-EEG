...
TOOLTIPS: Dict[str, str] = {
    ...
    "actuation_cooldown_ms": "Per-finger hold/cooldown interval in milliseconds.",
    "actuation_repeat_ms": "Minimum delay before repeating the same finger/action command in milliseconds.",
        ...
        return {
            ...
            "infer": [
                ...
                ArgSpec(
                    ...
                    "int",
                    "Per-finger hold/cooldown interval.",
                ),
                ArgSpec(
                    "actuation_repeat_ms",
                    "--actuation-repeat-ms",
                    "int",
                    "Minimum delay before repeating the same finger/action command.",
                ),
                ArgSpec(
                    "actuation_min_speed",
                    "--actuation-min-speed",
