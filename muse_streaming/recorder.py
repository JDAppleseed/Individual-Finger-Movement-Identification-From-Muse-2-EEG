...
def wrap_logger_with_session(
    logger: Optional[logging.Logger | logging.LoggerAdapter],
    session_id: str,
) -> Optional[SessionLoggerAdapter]:
    if logger is None:
        return None
    if isinstance(logger, logging.LoggerAdapter):
        ...
        raise TypeError("logger must be logging.Logger or logging.LoggerAdapter")
    return SessionLoggerAdapter(base_logger, {"session_id": session_id})
