...
\begin{lstlisting}[language=PythonSafe,caption={Excerpt from \texttt{\detokenize{utils/timebase_selfcheck.py}} L19--L53}]
...
These are placeholders to remind you what to cite as you refine lessons. Replace with the specific sources you used.

\begin{itemize}
\item Lab Streaming Layer (LSL): \url{https://labstreaminglayer.org/}
\item Muse / consumer EEG device documentation (vendor docs)
\item Calibration / reliability diagrams: search "Expected Calibration Error reliability diagram"
\item Motor rhythms (mu/beta) overview: standard EEG textbooks or review articles
\end{itemize}
